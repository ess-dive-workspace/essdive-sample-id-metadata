# ESS-DIVE Sample ID and Metadata Reporting Format (IGSN-ESS) v2.0.0
...
## Updates in v2.0.0  
- The Sample ID and Metadata reporting format revisions are currently under development. If you are interested in reviewing the revised sample metadata reporting format, please reach out to ESS-DIVE at ess-dive-support _at_ lbl.gov.
